    ...
    try:
        ...
        try:
            if _cron_inactivity_limit is None:
                ...
                # run_claim heartbeat, a wall-clock cap still has to be
                # enforced, and a cancel event still needs polling, so poll
                # if ANY applies rather than blocking.
                if _is_oneshot or _cron_max_run is not None or cancel_event is not None:
                    result = None
                    while True:
